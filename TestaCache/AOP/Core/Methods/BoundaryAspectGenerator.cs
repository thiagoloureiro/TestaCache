...
namespace TestaCache.AOP.Core.Methods
{
    internal class BoundaryAspectGenerator
    {
        ...
        private readonly AspectCalls _aspectCalls;
        ...
        private static Expression AssignMethodArgsByRetValue(Expression methArgEx, ParameterExpression retMethodValue)
        {
        ...
        internal class AspectCalls
        {
            ...
            private readonly IEnumerable<DynamicMetaObject> _args;
            ...
            private Expression GenerateCall(string methodName, OnMethodBoundaryAspect aspect)
            {
            ...
            private Expression GenerateOriginalCall()
            {
